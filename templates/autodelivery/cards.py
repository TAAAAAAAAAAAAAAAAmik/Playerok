...
CARDS = [
    Card(
        ...
        # Робуксы продают и через геймпасс: покупатель получает их внутри
        # игры, а не кодом. Товар называется так же — «80 РОБУКСОВ», — но
        # выдавать по нему подарочный код значит купить не то, что продано.
        name_must_not_have=("геймпас", "гейм пас", "гейм-пас", "gamepass",
                            "game pass", "game-pass", "гейпасс"),
    ...
    Card(
        ...
        title="Xbox",
        emoji="🟩",
        keywords=("xbox", "иксбокс", "хбокс", "икс бокс", "хбох",
                  "иск бокс", "x-box"),
        measure="$",
        ...
        name_must_not_have=("game pass", "gamepass", "game-pass",
                            ...
                            "гейпасс", "game core", "ultimate",
                            "подписка", "подписку"),
        activation="Активируйте код на xbox.com/redeem — войдите в свой "
                   "аккаунт Microsoft и введите код.",
        pitch="Пополняет кошелёк Microsoft: игры, Xbox и Windows Store. "
              "Не Game Pass — это подписка, отдельный товар.",
        measured="20.08",
        ad_title="Xbox Gift Card {номинал} {регион} — код, моментально",
        ad_text="Пополнение кошелька Microsoft на {номинал}.\n"
                "Регион: {регион}.\n\n"
                "⚠️ Регион кода и региона аккаунта должны совпадать: код "
                "{регион} активируется только на аккаунте {регион}. "
                "Сменить регион аккаунта можно в настройках Microsoft, "
                "пока кошелёк пуст.\n\n"
                "Активация: xbox.com/redeem — войдите в аккаунт Microsoft "
                "и введите код.\n"
                "Подходит для игр, дополнений и подписок в Microsoft Store.\n"
                "Это НЕ Game Pass: подписка — отдельный товар.\n\n"
                "Выдача автоматическая, код приходит в чат сразу после "
                "оплаты.",
    ),
    Card(
        slug="steam",
