...
3. ОПЛАЧЕНО — только PAID. SENT, CONFIRMED и CONFIRMED_AUTOMATICALLY
   означают, что товар уже отдан, ROLLED_BACK — что деньги вернули.
   Про PENDING («сделка в ожидании отправки товара») см. ниже: он выглядит
   оплаченным, но в список намеренно не включён.
...
#
# Если на живом заказе окажется, что PENDING — это честное «оплачено,
# ждём отправки», добавьте его сюда и допишите тест.
