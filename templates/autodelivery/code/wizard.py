...
#
# Регион спрашивается ДО характеристик площадки, и это не косметика. У
# гифт-карт площадка сама спрашивает страну или валюту («Валюта?» у Xbox —
# это три десятка стран), и до перестановки продавец отвечал на один и тот
# же вопрос дважды: сначала площадке, потом боту. Два ответа про одно —
# это рано или поздно два РАЗНЫХ ответа: в объявлении «Турция», в описании
# «Регион кода: US», выдача купит третье.
#
