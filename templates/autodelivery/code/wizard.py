...
# российскими, и турецкими, не должен упираться в список из двух.
#
# Список закрыт нарочно. Принять любые две буквы значило бы записать в
# товар регион, которого у поставщика нет, — и узнал бы об этом продавец
# из отказа, когда покупатель уже заплатил.
